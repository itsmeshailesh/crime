...
<html>
    <head>
        <title>Criminal Correction Management</title>
        <meta charset="UTF-8">
    ...
    <body id="mk">
        <div style="background-color: black;">
             <h1 style="margin-left:50px;font-size: 50px; color:whitesmoke;font:bold;">Criminal Correction Management</h1>  
        </div>
	...
	<div class="footer" style="position: fixed; left: 0; bottom: 0; width: 100%; background-color: gray; color: white; text-align: center;">
	  <p>&copy;2021 nischal bandhu&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Criminal Correction Management</p>
	</div>
    </body>
</html>
